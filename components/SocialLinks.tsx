...
function LinkedInIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M20.5 2h-17A1.5 1.5 0 0 0 2 3.5v17A1.5 1.5 0 0 0 3.5 22h17a1.5 1.5 0 0 0 1.5-1.5v-17A1.5 1.5 0 0 0 20.5 2zM8 19H5v-9h3v9zM6.5 8.3a1.75 1.75 0 1 1 0-3.5 1.75 1.75 0 0 1 0 3.5zM19 19h-3v-4.4c0-1-.4-1.7-1.3-1.7-.7 0-1.1.5-1.3 1-.1.2-.1.4-.1.7V19h-3s.04-8.2 0-9h3v1.3c.4-.6 1.1-1.5 2.7-1.5 2 0 3.4 1.3 3.4 4.1V19z" />
    </svg>
  );
}

// Edit these URLs to point at Cabin Zindagi's real profiles.
    ...
    <div className="flex items-center gap-3">
      {socials.map(({ name, href, Icon }) => (
        <a
          ...
          aria-label={name}
          className="flex h-9 w-9 items-center justify-center rounded-full border border-black/10 opacity-70 transition hover:border-brand hover:text-brandtext hover:opacity-100 dark:border-white/15"
        >
